...
topplot <- TOPDF %>%
  ...
  geom_text(aes(label = Site),  vjust = -2, hjust = 0.5, size = 1, family =  "GillSans", color = "black") +
...
ggsave(psave, filename = 'SAMPLE_HEATMAP.png', path = path, width = 4, height = 5, device = png, dpi = 300)
